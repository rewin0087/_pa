<!-- ADD MODAL -->
<div class="modal fade add-modal-sender" data-backdrop="static" data-keyboard="false" id="App-Views-AddSenderAddressModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
      <form>
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Add Sender Address</h4>
        </div>
        <div class="modal-body">
          ...
          <div class="col-xs-12 form-group receiving_first_name">
              <label for="receiving_first_name">Representative First Name</label>
          ...
          <div class="col-xs-12 form-group receiving_last_name">
              <label for="receiving_last_name">Representative Last Name</label>
