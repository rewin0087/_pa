<section id="select-options">
        ...
        <div class="col-xs-9">
            <div id="step-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6" id="setup-paper-holder">
                        <!-- SETUP PAPER -->
                        @include('web.printing.setup-options._partials.setup-paper')
                        <div class="row">
                            <div id="step-control-prv-nex">
                                <!-- GO BACK -->
                                <div class="col-xs-6">
                                    <a href="/printing/select-product" class="pull-left">
                                ...
                                <!-- GO NEXT -->
                                <div class="col-xs-6">
                                    <a href="/printing/setup-finishing" class="pull-right">
    ...
    <!-- Modals -->
    @include('web.printing.setup-options._partials.modals')
</section>