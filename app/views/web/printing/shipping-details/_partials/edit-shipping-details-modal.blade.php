            ...
            <div class="modal-content">
                <form class="shipping-details">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-xs-6 form-group delivery_cutoff_id">
                            <label for="delivery_cutoff_id">DESIRED DELIVERY TIME</label>
                            <select class="fancy" id="delivery_cutoff_id" name="delivery_cutoff_id">
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-xs-12">
                                <button type="button" href="#" class="darkbrown btn btn-xs update">UPDATE</button>
