<!-- ADD MODAL -->
<div class="modal fade add-modal" data-backdrop="static" data-keyboard="false" id="App-Views-AddProductPrintingPaperTypeModal" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <p class="text-danger">printer api must be a url type input</p>
                <input type="text" class="form-control" name="printer_api" placeholder="Printer API">
              </div>
              <!-- Price list -->
              <div class="form-group">
