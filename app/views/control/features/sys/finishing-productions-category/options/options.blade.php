          ...
          <form>
            ...
            <div class="modal-body">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dex_code" id="dex_code" value="<%= dex_code %>" placeholder="Dex Code">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dex_ar_name" id="dex_ar_name" value="<%= dex_ar_name %>" placeholder="Enter Dex Name[ar]">
              </div>
              <div class="form-group">
