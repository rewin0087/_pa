<!-- DELETE MODAL -->
<script type="text/template" id="App-Views-DeleteConfigDeliveryCutOffTimeModal">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Remove - <%= value %></h4>
          </div>
          <div class="modal-body">
            <div class="callout callout-danger">
            <p>Are you sure you want to remove <%= value %>?</p>
            </div>
          </div>
