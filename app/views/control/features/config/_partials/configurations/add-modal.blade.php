<!-- ADD MODAL -->
<div class="modal fade add-modal" data-backdrop="static" data-keyboard="false" id="App-Views-AddConfigConfigurationModal" tabindex="-1" role="dialog" aria-hidden="true">
