# Sys BadDataErrorOption View Edit Modal
class App.Control.Views.EditSysBadDataErrorOptionModal extends App.Views.Base
    template: 'App-Views-SysEditBadDataErrorOptionModal'
