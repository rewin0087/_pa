# Features Config DeliveryCutoffTimeModal View Edit Modal
class App.Control.Views.EditConfigDeliveryCutoffTimeModal extends App.Views.Base
    template: 'App-Views-EditConfigDeliveryCutOffTimeModal'
