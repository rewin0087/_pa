# Features Config Configuration View Add Modal
class App.Control.Views.AddConfigConfigurationModal extends App.Views.Base
    el: '#App-Views-AddConfigConfigurationModal'
    ...
    success: () ->
        ...
        # hide modal
        $('#App-Views-AddConfigConfigurationModal').modal('toggle')
        # reset value
        $('#value').val('')
