# Features Config CutOffTimeSettings View Add Modal
class App.Control.Views.AddConfigCutOffTimeSettingsModal extends App.Views.Base
    el: '#App-Views-AddConfigCutOffTimeSettingsModal'
    ...
    success: () ->
        ...
        # hide modal
        $('#App-Views-AddConfigCutOffTimeSettingsModal').modal('toggle')
        # reset value
        $('#value').val('')
