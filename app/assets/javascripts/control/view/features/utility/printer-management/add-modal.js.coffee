# Features Utility Printer-Management View Add Modal
class App.Control.Views.AddUtilityPrinterManagementModal extends App.Views.Base
    el: '#App-Views-AddUtilityPrinterManagementModal'
    ...
    success: () ->
        ...
        # hide modal
        $('#App-Views-AddUtilityPrinterManagementModal').modal('toggle')
        # reset value
        $('#value').val('')
