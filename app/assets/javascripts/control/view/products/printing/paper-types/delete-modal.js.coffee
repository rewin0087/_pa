# Product Printing PaperType View Delete Modal
class App.Control.Views.DeleteProductPrintingPaperTypeModal extends App.Views.Base
    template: 'App-Views-DeleteProductPrintingPaperTypeModal'
